...
upcomingDatabase.addProject("Upcoming"); //inbox is selected by default
    ...
    return input.addEventListener("click", function (e) {
      ...
      if (input.value === "Add" && inputField.value != "") {
        ...
        if (!isNaN(currentlySelected)) {
          ...
          var toDoTask = new _toDoList_js__WEBPACK_IMPORTED_MODULE_3__.toDoItem(name, desc, date, priority);
          ...
          var _toDoTask = new _toDoList_js__WEBPACK_IMPORTED_MODULE_3__.toDoItem(name, desc, date, priority);
          ...
          var currentDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(new Date(), "MM/dd/yyyy");

          if (date != currentDate) {
            date = currentDate;

            var _toDoTask2 = new _toDoList_js__WEBPACK_IMPORTED_MODULE_3__.toDoItem(name, desc, date, priority);

            _toDoList2.newItem(_toDoTask2);

            alert("Date automatically set to today");
          } else {
            var _toDoTask3 = new _toDoList_js__WEBPACK_IMPORTED_MODULE_3__.toDoItem(name, desc, date, priority);
...
function removePageLock() {
  var pageLock = document.querySelectorAll(".page-lock");
  pageLock.forEach(function (element) {
...
function todayHandler(todayDatabase, inboxDatabase, projectsDatabase) {
  ...
  var currentDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(new Date(), "MM/dd/yyyy"); //handles projectDatabase
      ...
      for (var project in obj) {
        ...
        try {
          for (_iterator4.s(); !(_step4 = _iterator4.n()).done;) {
            var toDoItem = _step4.value;

            if (toDoItem.getDueDate() == currentDate) {
              (0,_render_js__WEBPACK_IMPORTED_MODULE_0__.render)(toDoItem);
            }
          }
        } catch (err) {
          _iterator4.e(err);
      ...
      for (var _project in _obj) {
        ...
        try {
          for (_iterator5.s(); !(_step5 = _iterator5.n()).done;) {
            var _toDoItem = _step5.value;

            if (_toDoItem.getDueDate() == currentDate) {
              (0,_render_js__WEBPACK_IMPORTED_MODULE_0__.render)(_toDoItem);
            }
          }
        } catch (err) {
          _iterator5.e(err);
  ...
  try {
    for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
      ...
      (0,_render_js__WEBPACK_IMPORTED_MODULE_0__.render)(element);
    }
  } catch (err) {
    _iterator3.e(err);
  } finally {
...
function upcomingHandler(upcomingDatabse, inboxDatabase, projectsDatabase) {}
...
function deleteTaskPopup(e, database) {
  ...
  (0,_UI_js__WEBPACK_IMPORTED_MODULE_0__.addPageLock)();
  ...
  inputs.forEach(function (element) {
    element.addEventListener("click", function (e) {
      ...
      if (element.value == "Yes") {
        ...
        popup.remove();
        (0,_UI_js__WEBPACK_IMPORTED_MODULE_0__.removePageLock)();
      } else {
        popup.remove();
        (0,_UI_js__WEBPACK_IMPORTED_MODULE_0__.removePageLock)();
      }
...
var toDoList = /*#__PURE__*/function () {
  ...
  _createClass(toDoList, [{
    ...
    key: "findItem",
    value: function findItem(itemName) {
    ...
    key: "updateItem",
    value: function updateItem(itemName, updateType, updateData) {
